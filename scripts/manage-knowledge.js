...
// Knowledge always lives in app-docs for simplicity
...
function printUsage() {
  ...
  console.log('  archive <file>           Move a spec from active/ to archive/');
  console.log('  restore <file>           Move a spec from archive/ back to active/');
}
