...
echo ""
echo "  1. Run your first slash command (e.g., /baw_dev_discovery or /baw_dev_plan) to capture context."
echo ""
...
echo "     • /baw_dev_quick_build \"add env var validation\"       # small change"
echo "     • /baw_dev_discovery_build \"add JWT auth\"            # medium change"
echo "     • /baw_dev_full_pipeline \"implement billing\" \"docs\" budget  # large change"
echo ""
echo "  5. After any build command, run /baw_dev_test and follow the prompts."
echo ""
