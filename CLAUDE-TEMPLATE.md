...
- **ai-docs/workflows/**: Scout, plan, build, report processes
...
### Workflow Documents
- 🔍 **Scout**: [ai-docs/workflows/scout.md](ai-docs/workflows/scout.md) - Multi-agent file discovery (10K tokens)
- 📋 **Plan**: [ai-docs/workflows/plan.md](ai-docs/workflows/plan.md) - Architecture planning (30K tokens)
- 🔨 **Build**: [ai-docs/workflows/build.md](ai-docs/workflows/build.md) - Implementation (50K tokens)
- 📊 **Report**: [ai-docs/workflows/report.md](ai-docs/workflows/report.md) - Summary & next steps (5K tokens)
...
```bash
/scout_plan_build_report "[task description]" "[doc-urls]"
```
...
### Option 2: Partial Workflow (Medium projects)

```bash
# Scout + Build (skip plan for simple tasks)
...
```
project-root/
├── ai-docs/                    # AI agents, workflows, build artifacts
│   ├── agents/                 # Agent prompts and configs
│   ├── workflows/              # scout.md, plan.md, build.md, report.md
│   ├── plans/                  # Generated implementation plans
│   ├── builds/                 # Build logs and reports
│   ├── reports/                # Workflow summaries
│   ├── archives/               # Historical build artifacts
│   ├── logs/                   # Token usage, metrics
│   └── mcp-configs/            # MCP tool configurations
│
...
```bash
# Full workflow
/scout_plan_build_report "Add user authentication" "https://docs.example.com/auth"

# Partial workflow
/scout_build "Fix login bug"

# Individual phases
/scout "Find files related to authentication" "4"
/plan "Plan authentication refactor" "https://..." "[files]"
...
2. ✅ **Check**: app-docs/mappings/feature-to-source.md for patterns
...
3. **Create Initial Documentation**
   ...
   # Create feature-to-source.md mapping
   ```
